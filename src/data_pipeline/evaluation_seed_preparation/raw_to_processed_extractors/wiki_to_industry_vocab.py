...
from ...shared_pipeline_support.data_file_paths import INDUSTRY_CANONICAL, RAW_WIKIPEDIA_GLOSSARIES, WIKI_AUTO
    ...
    *,
    ...
    payload = {
        "metadata": {
            "version": "0.1.0",
            "source": "wikipedia",
            "extractor": "data_pipeline.evaluation_seed_preparation.raw_to_processed_extractors.wiki_to_industry_vocab",
