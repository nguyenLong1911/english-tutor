"""Data Generation Orchestrator for the A20 Agentic Language Tutor.

This rewrite follows the architecture described in
``docs/Hướng dẫn AI Agent thu thập dữ liệu.md``:

* Constrained Decoding (Pydantic structured output) via ``StructuredLLM``
* Exponential backoff with jitter on transient failures
* Multi-stage synthetic engineering: seed → expand → judge → decontaminate
* Multi-tier PII scrubbing on every persisted memory fact
...
Dependencies: openai>=1.50, pydantic>=2, python-dotenv, tqdm.
"""
...
from .env import load_pipeline_env  # noqa: E402
from .json_io import load_json, save_json  # noqa: E402
from .llm_client import StructuredLLM  # noqa: E402
from .paths import GENERATED_DATASETS as PATHS  # noqa: E402
from .pii_filter import PIISentinel  # noqa: E402
...
from .synthetic import SyntheticPipeline  # noqa: E402
...
def make_llm() -> StructuredLLM:
    """Build a Vertex-backed StructuredLLM for synthetic data preparation."""
...
def add_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    ``a20-pipeline generate`` subcommand in :mod:`data_pipeline.cli`.
    """
    parser.add_argument(
        "--task",
