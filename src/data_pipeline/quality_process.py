...
from .paths import ERROR_BANK, INDUSTRY_CANONICAL, IELTS, PEDAGOGICAL, MOOD, MEM0, QUALITY_PROCESS_REPORT
...
def quality_review_errors() -> dict[str, Any]:
    ...
    data["metadata"]["alpha_quality_review"] = {
        ...
        "source": "src.data_pipeline.quality_process.quality_review_errors",
    }
...
def quality_review_industry() -> dict[str, Any]:
    ...
    data.setdefault("metadata", {})["alpha_quality_review"] = {
        ...
        "source": "src.data_pipeline.quality_process.quality_review_industry",
    }
...
def quality_review_ielts() -> dict[str, Any]:
    ...
    data.setdefault("metadata", {})["alpha_quality_review"] = {
        ...
        "source": "src.data_pipeline.quality_process.quality_review_ielts",
    }
...
def _review_collection(path: Path, list_key: str, id_prefix: str) -> dict[str, Any]:
    ...
    data.setdefault("metadata", {})["alpha_quality_review"] = {
        ...
        "source": f"src.data_pipeline.quality_process.{path.name}",
    }
    save_json(path, data)
    return data["metadata"]["alpha_quality_review"]
...
def quality_review_mem0() -> dict[str, Any]:
    ...
    data.setdefault("metadata", {})["alpha_quality_review"] = {
        ...
        "source": "src.data_pipeline.quality_process.quality_review_mem0",
    }
    save_json(MEM0, data)
    return data["metadata"]["alpha_quality_review"]
