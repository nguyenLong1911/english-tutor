...
:mod:`data_pipeline.sources.huggingface`, computes a token-level diff
...
from ..json_io import read_jsonl, save_json
from ..paths import JFLEG_AUTO, RAW_JFLEG
from ..schemas import ESLErrorInstance
    ...
    *,
    ...
    payload = {
        "metadata": {
            ...
            "extractor": "rule-based diff (data_pipeline.extractors.jfleg_to_errors)",
            "needs_review": True,
...
# ---------------------------------------------------------------------------
# CLI helper (also wired up in data_pipeline.cli)
# ---------------------------------------------------------------------------
