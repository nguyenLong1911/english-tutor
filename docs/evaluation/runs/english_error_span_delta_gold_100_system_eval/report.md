...
| Field | Value |
|---|---|
| run_id | english_error_span_delta_gold_100_system_eval |
| started_at | 2026-05-15T11:56:48+00:00 |
| ended_at | 2026-05-15T11:59:24+00:00 |
...
| span_recall | 0.0153 |
| span_f1 | 0.0302 |
| average_error_detection_rate_per_sentence | 0.0263 |
| mean_sentence_span_recall | 0.0263 |
| mean_sentence_span_precision | 0.0606 |
| mean_sentence_span_f1 | 0.0365 |
| matched_spans | 13 |
| gold_spans | 847 |
| system_spans | 13 |
| sentence_full_match_rate | 0.0 |
| latency_ms | {'p50': 1514.0, 'p95': 1697.0} |
...
| 2 | ok | ["Calls for fast food tax to turn 'industry on its head'", "says", "impact", "the Supermarkets", "your", "KFC's"] | ["Calls for fast food tax", "the Supermarkets", "KFC's"] | 0.50 | 1.00 |
| 3 | ok | ["Is Said to Start", "Next Week", "targeting", "Sanctuary Cities", "Surely", "they’ll", "Maybe…", "texas"] | ["Is", "Next Week", "texas"] | 0.38 | 1.00 |
| 4 | ok | ["Loved", "Just a", "nice", "hang in"] | ["Loved", "hang in"] | 0.50 | 1.00 |
| 5 | ok | ["We have freedom of speech in EU,", "say whatever they want", "if it is far right", "npr"] | [] | 0.00 | 0.00 |
| 6 | ok | ["canceled", "And"] | ["And the guy who gave him the pen"] | 0.50 | 1.00 |
| 7 | ok | ["groupexposed", "investigationHe", "it though", "necessary.The", "Blair and"] | ["groupexposed", "investigationHe"] | 0.40 | 1.00 |
